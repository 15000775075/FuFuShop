...
namespace FuFuShop.Admin.Controllers
{
    ...
    public class GoodsCommentController : ControllerBase
    {
        ...
        /// 构造函数
        ///</summary>
        public GoodsCommentController(IWebHostEnvironment webHostEnvironment
        ...
        #region 获取列表============================================================
        // POST: Api/GoodsComment/GetPageList
        /// <summary>
        /// 获取列表
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<AdminUiCallBack> GetPageList()
        {
            ...
            var where = PredicateBuilder.True<GoodsComment>();
            //获取排序字段
            var orderField = Request.Form["orderField"].FirstOrDefault();
            Expression<Func<GoodsComment, object>> orderEx;
            switch (orderField)
            {
                case "id":
                    orderEx = p => p.id;
            ...
            //获取数据
            var list = await _GoodsCommentServices.QueryPageAsync(where, orderEx, orderBy, pageCurrent, pageSize, true);
            //返回数据
            jm.data = list;
            jm.code = 0;
        ...
        #region 首页数据============================================================
        // POST: Api/GoodsComment/GetIndex
        /// <summary>
        /// 首页数据
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<AdminUiCallBack> GetEdit([FromBody] FMIntId entity)
        {
            ...
            var model = await _GoodsCommentServices.DetailsByIdAsync(p => p.id == entity.id, p => p.id, OrderByType.Desc);
            if (model == null)
            {
                jm.msg = "不存在此信息";
                return jm;
        ...
        {
            var jm = await _GoodsCommentServices.Reply(entity.id, entity.data.ToString());
            return jm;
        }
        #endregion

        #region 删除数据============================================================
        // POST: Api/GoodsComment/DoDelete/10
        /// <summary>
        /// 单选删除
        /// </summary>
        /// <param name="entity"></param>
        ...
        public async Task<AdminUiCallBack> DoDelete([FromBody] FMIntId entity)
        {
            ...
            var model = await _GoodsCommentServices.ExistsAsync(p => p.id == entity.id, true);
            if (!model)
            {
                jm.msg = GlobalConstVars.DataisNo;
                return jm;
            }
            jm = await _GoodsCommentServices.DeleteByIdAsync(entity.id);
        ...
        #region 预览数据============================================================
        // POST: Api/GoodsComment/GetDetails/10
        /// <summary>
        /// 预览数据
        /// </summary>
        /// <param name="entity"></param>
        ...
        #region 设置前台显示============================================================
        // POST: Api/GoodsComment/DoSetisDisplay/10
        /// <summary>
        /// 设置前台显示
        /// </summary>
        /// <param name="entity"></param>
        ...
        public async Task<AdminUiCallBack> DoSetisDisplay([FromBody] FMUpdateBoolDataByIntId entity)
        {
            ...
            var oldModel = await _GoodsCommentServices.QueryByIdAsync(entity.id, false);
            if (oldModel == null)
            {
                jm.msg = "不存在此信息";
                return jm;
            }
            oldModel.isDisplay = entity.data;

            jm = await _GoodsCommentServices.UpdateAsync(oldModel);
