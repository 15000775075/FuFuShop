...
namespace FuFuShop.Admin.Controllers
{
    ...
    public class CoreCmsBillAftersalesController : ControllerBase
    {
        ...
        private readonly IBillAftersalesItemServices _itemServices;
        ...
        public CoreCmsBillAftersalesController(IWebHostEnvironment webHostEnvironment
            ...
            , IBillAftersalesImagesServices imagesServices
        ...
        // POST: Api/BillAftersales/GetPageList
        /// <summary>
        ///     获取列表
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<AdminUiCallBack> GetPageList()
        {
            ...
            Expression<Func<BillAftersales, object>> orderEx;
            switch (orderField)
            {
                case "aftersalesId":
            ...
            //获取数据
            var list = await _BillAftersalesServices.QueryPageAsync(where, orderEx, orderBy, pageCurrent, pageSize);
        ...
        // POST: Api/BillAftersales/GetIndex
        /// <summary>
        ///     首页数据
        /// </summary>
        /// <returns></returns>
        ...
        // POST: Api/BillAftersales/GetEdit
        /// <summary>
        ///     审核数据
        /// </summary>
        ...
        public async Task<AdminUiCallBack> GetEdit([FromBody] FMStringId entity)
        {
            ...
            var model = await _BillAftersalesServices.PreAudit(entity.id);
            if (!model.status)
            {
                jm.msg = model.msg;
                return jm;
        ...
        public async Task<AdminUiCallBack> DoEdit([FromBody] FMBillAftersalesAddPost entity)
        {
            ...
            var res = await _BillAftersalesServices.Audit(entity.aftersalesId, entity.status, entity.type,
        ...
        // POST: Api/BillAftersales/GetDetails/10
        /// <summary>
        ///     预览数据
        /// </summary>
        /// <param name="entity"></param>
        ...
        public async Task<AdminUiCallBack> GetDetails([FromBody] FMStringId entity)
        {
            ...
            var model = await _BillAftersalesServices.QueryByIdAsync(entity.id);
            if (model == null)
            {
                jm.msg = "不存在此信息";
                return jm;
        ...
        // POST: Api/BillAftersales/SelectExportExcel/10
        /// <summary>
        ///     选择导出
        /// </summary>
        /// <param name="entity"></param>
        ...
        public async Task<AdminUiCallBack> SelectExportExcel([FromBody] FMArrayStringIds entity)
        {
            ...
            //获取list数据
            var listmodel =
                await _BillAftersalesServices.QueryListByClauseAsync(p => entity.id.Contains(p.aftersalesId),
            ...
            var fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "-BillAftersales导出(选择结果).xls";
        ...
        // POST: Api/BillAftersales/QueryExportExcel/10
        /// <summary>
        ///     查询导出
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<AdminUiCallBack> QueryExportExcel()
        {
            ...
            //获取list数据
            var listmodel =
                await _BillAftersalesServices.QueryListByClauseAsync(where, p => p.createTime,
                    OrderByType.Asc);
            //给sheet1添加第一行的头部标题
            var row1 = sheet1.CreateRow(0);
            row1.CreateCell(0).SetCellValue("售后单id");
            ...
            var webRootPath = _webHostEnvironment.WebRootPath;
            var tpath = "/files/" + DateTime.Now.ToString("yyyy-MM-dd") + "/";
            var fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "-BillAftersales导出(查询结果).xls";
            var filePath = webRootPath + tpath;
            var di = new DirectoryInfo(filePath);
            if (!di.Exists) di.Create();
            var fileHssf = new FileStream(filePath + fileName, FileMode.Create);
