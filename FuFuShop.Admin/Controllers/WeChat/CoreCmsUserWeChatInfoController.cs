...
namespace FuFuShop.Admin.Controllers.WeChat
{
    /// <summary>
    ///     用户表
    /// </summary>
    ...
    public class UserWeChatInfoController : ControllerBase
    {
        ...
        public UserWeChatInfoController(IWebHostEnvironment webHostEnvironment
        ...
        // POST: Api/UserWeChatInfo/GetPageList
        /// <summary>
        ///     获取列表
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<AdminUiCallBack> GetPageList()
        {
            ...
            var where = PredicateBuilder.True<UserWeChatInfo>();
            //获取排序字段
            var orderField = Request.Form["orderField"].FirstOrDefault();
            Expression<Func<UserWeChatInfo, object>> orderEx;
            switch (orderField)
            {
                case "id":
                    orderEx = p => p.id;
            ...
            //获取数据
            var list = await _UserWeChatInfoServices.QueryPageAsync(where, orderEx, orderBy, pageCurrent,
                pageSize);
            //返回数据
            jm.data = list;
            jm.code = 0;
        ...
        // POST: Api/UserWeChatInfo/GetIndex
        /// <summary>
        ///     首页数据
        /// </summary>
        /// <returns></returns>
        ...
        // POST: Api/UserWeChatInfo/GetCreate
        /// <summary>
        ///     创建数据
        /// </summary>
        /// <returns></returns>
        ...
        // POST: Api/UserWeChatInfo/DoCreate
        /// <summary>
        ///     创建提交
        /// </summary>
        ...
        [HttpPost]
        [Description("创建提交")]
        public async Task<AdminUiCallBack> DoCreate([FromBody] UserWeChatInfo entity)
        {
            var jm = new AdminUiCallBack();

            var bl = await _UserWeChatInfoServices.InsertAsync(entity) > 0;
            jm.code = bl ? 0 : 1;
        ...
        // POST: Api/UserWeChatInfo/GetEdit
        /// <summary>
        ///     编辑数据
        /// </summary>
        /// <param name="entity"></param>
        ...
        public async Task<AdminUiCallBack> GetEdit([FromBody] FMIntId entity)
        {
            ...
            var model = await _UserWeChatInfoServices.QueryByIdAsync(entity.id);
            if (model == null)
            {
                jm.msg = "不存在此信息";
                return jm;
        ...
        [HttpPost]
        [Description("编辑提交")]
        public async Task<AdminUiCallBack> DoEdit([FromBody] UserWeChatInfo entity)
        {
            var jm = new AdminUiCallBack();

            var oldModel = await _UserWeChatInfoServices.QueryByIdAsync(entity.id);
            if (oldModel == null)
            {
                jm.msg = "不存在此信息";
                return jm;
            ...
            //事物处理过程结束
            var bl = await _UserWeChatInfoServices.UpdateAsync(oldModel);
            jm.code = bl ? 0 : 1;
        ...
        // POST: Api/UserWeChatInfo/DoDelete/10
        /// <summary>
        ///     单选删除
        /// </summary>
        /// <param name="entity"></param>
        ...
        public async Task<AdminUiCallBack> DoDelete([FromBody] FMIntId entity)
        {
            ...
            var bl = await _UserWeChatInfoServices.DeleteByIdAsync(entity.id);
            jm.code = bl ? 0 : 1;
        ...
        // POST: Api/UserWeChatInfo/DoBatchDelete/10,11,20
        /// <summary>
        ///     批量删除
        /// </summary>
        /// <param name="entity"></param>
        ...
        public async Task<AdminUiCallBack> DoBatchDelete([FromBody] FMArrayIntIds entity)
        {
            ...
            var bl = await _UserWeChatInfoServices.DeleteByIdsAsync(entity.id);
            jm.code = bl ? 0 : 1;
            jm.msg = bl ? GlobalConstVars.DeleteSuccess : GlobalConstVars.DeleteFailure;
        ...
        // POST: Api/UserWeChatInfo/GetDetails/10
        /// <summary>
        ///     预览数据
        /// </summary>
        /// <param name="entity"></param>
        ...
        // POST: Api/UserWeChatInfo/SelectExportExcel/10
        /// <summary>
        ///     选择导出
        /// </summary>
        /// <param name="entity"></param>
        ...
        public async Task<AdminUiCallBack> SelectExportExcel([FromBody] FMArrayIntIds entity)
        {
            ...
            //获取list数据
            var listmodel =
                await _UserWeChatInfoServices.QueryListByClauseAsync(p => entity.id.Contains(p.id),
            ...
            var fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "-UserWeChatInfo导出(选择结果).xls";
        ...
        // POST: Api/UserWeChatInfo/QueryExportExcel/10
        /// <summary>
        ///     查询导出
        /// </summary>
        /// <returns></returns>
        ...
        public async Task<AdminUiCallBack> QueryExportExcel()
        {
            ...
            //获取list数据
            var listmodel =
                await _UserWeChatInfoServices.QueryListByClauseAsync(where, p => p.id, OrderByType.Asc);
            //给sheet1添加第一行的头部标题
            var row1 = sheet1.CreateRow(0);
            row1.CreateCell(0).SetCellValue("用户ID");
            row1.CreateCell(1).SetCellValue("第三方登录类型");
            ...
            var webRootPath = _webHostEnvironment.WebRootPath;
            var tpath = "/files/" + DateTime.Now.ToString("yyyy-MM-dd") + "/";
            var fileName = DateTime.Now.ToString("yyyyMMddHHmmssfff") + "-UserWeChatInfo导出(查询结果).xls";
            var filePath = webRootPath + tpath;
            var di = new DirectoryInfo(filePath);
            if (!di.Exists) di.Create();
            var fileHssf = new FileStream(filePath + fileName, FileMode.Create);
