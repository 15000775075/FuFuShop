...
builder.Services.AddSwaggerGen((s) =>
{
    ...
    typeof(CustomApiVersion.ApiVersions).GetEnumNames().ToList().ForEach(version =>
    {
        ...
        {
            Version = version,
            Title = $"FuFuShop.Admin接口文档",
            Description = $"FuFuShop.AdminHTTP API " + version,
            Contact = new OpenApiContact { Name = "FuFuShop.AdminApi", Email = "", Url = new Uri("http://www.baidu.com") },
        });
