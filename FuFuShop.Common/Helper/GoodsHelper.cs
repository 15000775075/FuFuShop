...
namespace FuFuShop.Common.Helper
{
    ...
    public static class GoodsHelper
    {
        ...
        public static DTree GetTree(List<GoodsCategory> categories, bool isHaveTop = true)
        {
        ...
        /// <returns></returns>
        private static List<dtreeChild> GetMenus(List<GoodsCategory> oldNavs, int parentId)
        {
