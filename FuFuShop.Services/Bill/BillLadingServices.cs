...
namespace FuFuShop.Services
{
    ...
    /// 提货单表 接口实现
    /// </summary>
    public class BillLadingServices : BaseServices<BillLading>, IBillLadingServices
    {

        private readonly IBillLadingRepository _dal;
        private readonly IClerkRepository _clerkRepository;
        private readonly IStoreRepository _storeRepository;
        private readonly IOrderItemRepository _orderItemRepository;
        private readonly IUserRepository _userRepository;
        private readonly IUnitOfWork _unitOfWork;
        public BillLadingServices(IUnitOfWork unitOfWork,
            IBillLadingRepository dal,
