...
namespace FuFuShop.Services
{
    ...
    ///     微信支付 接口实现
    /// </summary>
    public class WeChatPayServices : BaseServices<Setting>, IWeChatPayServices
    {
        ...
        /// <returns></returns>
        public async Task<WebApiCallBack> PubPay(BillPayments entity)
        {
        ...
        /// <returns></returns>
        public async Task<WebApiCallBack> Refund(BillRefund refundInfo, BillPayments paymentInfo)
        {
            var jm = new WebApiCallBack();
