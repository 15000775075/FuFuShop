...
namespace FuFuShop.Services.Shop
{
    ...
    ///     配送方式表 服务工厂接口
    /// </summary>
    public interface IShipServices : IBaseServices<Ship>
    {
        /// <summary>
        ///     设置是否默认
        /// </summary>
        ...
        /// <returns></returns>
        decimal calculate_fee(Ship ship, decimal weight, decimal totalmoney = 0, decimal firstunitAreaPrice = 0);

        /// <summary>
        ///     根据地区获取配送方式
        /// </summary>
        Ship GetShip(int areaId = 0);
